...
public class NotificationsManager {
     ...
     */
    public NotificationCompat.Builder createDownloadNotification(@NonNull Context context, String title, String contentText){
    ...
    public void updateDownloadNotification(@NonNull Context context, NotificationCompat.Builder builder){
        NotificationManager notificationManager =
                (NotificationManager) context.getSystemService(Context.NOTIFICATION_SERVICE);
        if (notificationManager != null) {
    ...
    public void finishDownloadNotification(@NonNull Context context, NotificationCompat.Builder builder, String fileLocation, String fileName){
        NotificationManager notificationManager =
                (NotificationManager) context.getSystemService(Context.NOTIFICATION_SERVICE);
        if (notificationManager != null) {
